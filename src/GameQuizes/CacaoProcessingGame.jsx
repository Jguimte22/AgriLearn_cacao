...
import CacaoFarm from '/CacaoFarm.png';
...
const CacaoProcessingGame = () => {
  ...
  useEffect(() => {
    document.body.style.backgroundImage = `url(${CacaoFarm})`;
            ...
            <div className="game-header">
              ...
              <div className="combo">
                {combo > 0 ? (
                  ...
                  <span className="combo-placeholder">No streak</span>
                )}
              </div>
              <div className="card-counter">
                Card {currentCardIndex + 1} of {quizItems.length}
              </div>
            </div>
