...
const CareManagementGame = () => {
  ...
  if (!gameStarted) {
    return (
      <div className="care-game-landing">
        <div className="care-game-wrapper">
          <div className="landing-header">
            <div className="game-icon">
              <FaLeaf />
            </div>
            <h1>Cacao Care Master</h1>
            <p className="game-tagline">Master the Art of Cacao Care</p>
          </div>
          ...
          <div className="landing-content">
            <div className="game-stats">
              ...
              <div className="stat">
                ...
                <span className="label">Practical</span>
              </div>
            </div>

            <div className="game-description">
              <h3>🎯 Test Your Knowledge</h3>
              <p>Challenge yourself with questions about cacao plant care and maintenance. Learn best practices for keeping your cacao trees healthy and productive.</p>
            </div>

            <div className="care-methods-showcase">
              <h3>🌱 Care Topics Covered</h3>
              <div className="methods-grid">
                <div className="method-card">
                  <div className="method-icon">💧</div>
                  <h4>Watering</h4>
                  <p>Optimal irrigation techniques</p>
                </div>
                <div className="method-card">
                  <div className="method-icon">🐛</div>
                  <h4>Pest Control</h4>
                  <p>Common pest management</p>
                </div>
                <div className="method-card">
            ...
            <div className="button-group">
              <button className="btn btn-outline" onClick={handleBackToLessons}>
                Back to Lessons
              </button>
