...
import { FaArrowLeft, FaPlay, FaRedo, FaLightbulb, FaTrophy, FaClock, FaStar, FaFire, FaRocket, FaGem, FaPause } from 'react-icons/fa';
        ...
        <div className="landing-page" style={{
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{
                    ...
                    color: '#8B4513',
                    marginBottom: '0.2rem'
                  }}>See Scrambled Word</div>
                  <div style={{
                    fontSize: '0.8rem',
                    color: '#64748b',
                    lineHeight: '1.3'
                  }}>Look at the mixed-up letters</div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{
                    ...
                    color: '#64748b',
                    lineHeight: '1.3'
                  }}>Earn streaks for bonus points</div>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <FaFire style={{ fontSize: '1rem', color: '#4a7c59' }} />
                  <span><strong style={{ color: '#4a7c59' }}>Streaks:</strong> Build combos</span>
                </div>
                <div style={{
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  <FaLightbulb style={{ fontSize: '1rem', color: '#4a7c59' }} />
                  <span><strong style={{ color: '#4a7c59' }}>Hints:</strong> Use power-ups</span>
                </div>
                <div style={{
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  <FaTrophy style={{ fontSize: '1rem', color: '#4a7c59' }} />
                  <span><strong style={{ color: '#4a7c59' }}>Perfect:</strong> No mistakes!</span>
                </div>
                <div style={{
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  <FaRocket style={{ fontSize: '1rem', color: '#4a7c59' }} />
                  <span><strong style={{ color: '#4a7c59' }}>Speed:</strong> Quick answers</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="start-section" style={{
            ...
            <p className="start-hint" style={{
              ...
              color: '#64748b',
              textAlign: 'center'
            }}>Ready to master Good Agricultural Practices?</p>
          </div>
        </div>
      )}
            ...
            <div className="game-header" style={{
              ...
              <div className="game-stats" style={{
                ...
                <div className="stat" style={{
                  ...
                  <FaStar style={{ color: '#ffa500' }} /> {score}
                  {levelScore > 0 && <span className="score-popup" style={{
                    position: 'absolute',
                    top: '-10px',
                    right: '-10px',
                    background: '#4caf50',
                ...
                <div className="stat" style={{
                  ...
                  <FaClock style={{ color: '#ff6b6b' }} /> {timeLeft}s
                </div>
                <div className="stat" style={{
                  background: 'rgba(255, 255, 255, 1)',
                  padding: '0.75rem 1.25rem',
                  ...
                  <FaFire style={{ color: '#ff9500' }} /> {combo}x
                </div>
              </div>
            </div>
