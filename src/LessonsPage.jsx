              ...
              <div className="module-item-container">
                ...
                >
                  <div className="module-item-head">
                    {module.id !== 'module-6' && module.id !== 'module-19' && (
                ...
                <div key={module.id} className="mobile-module-card-wrapper">
                  <div
                    ...
                    onClick={() => {
                      ...
                      if (module.id === 'module-6' || module.id === 'module-12' || module.id === 'module-19') {
                        setActiveModuleId(module.id);
                        setSelectedLesson(null);
                        setShowMobileModules(false);
                      } else {
                  ...
                  >
                    <div className="mobile-module-card-header">
                      <span className="mobile-module-index">
                        {module.id === 'module-6' || module.id === 'module-12' || module.id === 'module-19' ? 'Video Module' : `Module ${index + 1}`}
                      </span>
                      {module.id !== 'module-6' && module.id !== 'module-12' && module.id !== 'module-19' && (
                      ...
                      {module.lessons.map((lesson, lessonIndex) => (
                        ...
                        >
                          ...
                          <div className="mobile-lesson-content">
                            <h4>{lesson.title}</h4>
                            <p>{lessonContents[lesson.id]?.content?.[0]?.substring(0, 80) + '...' || 'Tap to view lesson'}</p>
                          </div>
            ...
            <div className="single-video-container">
              ...
              <div className="video-info">
                ...
                <div className="video-meta">
                  <span className="video-duration">3:27 minutes</span>
          ...
          <div className="video-content">
            ...
            <div className="single-video-container">
              ...
              <div className="video-info">
                ...
                <div className="video-meta">
                  <span className="video-duration">12 minutes</span>
          ...
          <div className="video-content">
            ...
            <div className="single-video-container">
              ...
              <div className="video-info">
                ...
                <div className="video-meta">
                  <span className="video-duration">15 minutes</span>
                  <span className="video-views">2.3K views</span>
                </div>
              </div>
            </div>
          </div>
