                      ...
                      <div key={course.id} className="bar-item">
                        ...
                        <div className="bar-bg">
                          <div
                            ...
                            style={{
                              width: `${progress}%`,
                              backgroundColor: progress === 100 ? '#8B5A2B' :
                                progress > 0 ? '#D4A76A' : '#f0f0f0'
                            }}
                          ></div>
                        </div>
                      </div>
                ...
                <div className="user-activity-enhanced">
                  ...
                  <div className="activity-item-enhanced">
                    ...
                    <div className="activity-content">
                      ...
                      {/* Display actual unlocked achievements */}
                      {userAchievements.unlocked && userAchievements.unlocked.length > 0 ? (
                        <div className="unlocked-achievements-list" style={{ marginTop: '10px' }}>
                          {userAchievements.unlocked.map((ua, index) => {
                            const achievement = ua.achievementId;
                            if (!achievement) return null;

                            return (
                              <div key={achievement._id || index} className="achievement-item" style={{
                                fontSize: '11px',
                                color: '#8B5A2B',
                                marginBottom: '3px',
                                display: 'flex',
                                ...
                                <span style={{ marginRight: '5px' }}>{getIconComponent(achievement.icon)}</span>
                                {achievement.name}
                              </div>
                            );
                          })}
                        ...
                        <div style={{ marginTop: '10px', fontSize: '10px', color: '#999', fontStyle: 'italic' }}>
        ...
        <div className="modal-overlay" onClick={cancelLogout}>
          <div className="modal logout-confirmation-modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button onClick={cancelLogout} className="close-btn">
                <FiX />
              </button>
            </div>
